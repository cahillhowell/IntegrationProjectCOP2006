...
public class playingWithNumbers {
  public static void numbers() {
    ...
    // Creating a block of code that will hold the values for the next block of statements
    ...
    String mathIsHappening =
        "Using 2 random bytes and 3 declared bytes, and the random utility I will let java perform some math";
    ...
    // block of code will use the double variables above and show examples of how math util works
    ...
    String someMoreMath =
        "The ternary operator can act like an if else statement, and is handy in certain situations.";
    ...
    // This will tell the user what the numbers are, and do the work in the background

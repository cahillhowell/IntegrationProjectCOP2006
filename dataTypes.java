...
public class dataTypes {
  public static void data() throws InterruptedException {
    ...
    boolean pineapplePizzaYes = true; // if you want a false the value will have to come out to
                                      ...
                                      // youll have it come out to PizzaYes
    ...
    // Go through and make all the variables visible and to tell the user what they are
    System.out.println("Byte: " + numberOne + " " + "Short: " + numberTwo + " " + "Int: "
        + numberThree + " " + "Double " + numberFour);
    System.out.println(
        "Float: " + numberFive + " " + "Long: " + numberSix + " " + "Char: " + letterForWumbo);
    ...
    String finalDescription =
        "All values do have the ability to be changed at anytime, however if you wanted to create a value that couldn't change\n"
    ...
    String castingDescription =
        "It's also possible to sometimes change an intial data type to a different one if desired, such as changing\n"

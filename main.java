...
/*  Programmer - Cahill Howell
	Date Started - 5/18/2020
	Version 1.5.4
	Version Key - Major.Minor.Micro
	
This program is designed to be a work-out program that has a multitude of
work-outs to do. The program will function as hopefully an interactive
form to get random work-outs, grouped by similar structures, like
arms, legs, core, etc. It will ask the user what type of grouping they want
to try, then it will ask the intensity like, easy, medium, or hard. Then
it will pick through that library of work-outs and output like 5-6 different
ones along with reasonable amounts of reps or timing for that work-out.
...
public class main {
	public static void main(String[] args) {
		...
		System.out.println(" ");
		System.out.println("Please type out the number of");

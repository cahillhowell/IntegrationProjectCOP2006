...
public class laundryDay {
  public static void laundry() {
    ...
    String introLaundry =
        "You can use a switch statement to select one of many code blocks to be executed!"
    ...
    // creates what will be evaluated and then spit out as a result, one of the days will be output
    switch (day) {
      case 1:
